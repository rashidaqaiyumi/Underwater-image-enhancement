...
def NUCE(img):
    ...
    neutralized = neutralize_image(img)
    
    # Step 2: Apply PSO-based color correction
    pso_corrected = pso_image(neutralized)
    
    # Step 3: Apply stretching
    ls_img, us_img = Stretching(pso_corrected)
    
    # Step 4: Combine stretched images
    enhanced = enhanced_image(ls_img, us_img)
    
    # Step 5: Apply unsharp masking for detail enhancement
    final_img = unsharp_masking(enhanced)
